...
<head>
    ...
    <title><?php echo (isset($detail['title']) || isset($category['title']))? (isset($detail['title']))? $detail['title'] : $category['title'] : 'ENJOY VIETNAM | Diamond Tour' ?></title>
    <meta name="description" content="<?php echo (isset($detail['title']))? (isset($detail['metadescription']) && !empty($detail['metadescription']	))? $detail['metadescription']: $detail['title'] : 'ENJOY VIETNAM | Diamond Tour' ?>">
    <meta name="keywords" content="<?php echo (isset($detail['title']))? (isset($detail['metakeywords']) && !empty($detail['metakeywords']	))? $detail['metakeywords']: $detail['title'] : 'ENJOY VIETNAM | Diamond Tour' ?>">
