                        ...
                        <div class="box box-default">
                            <div class="box-body">
                                ...
                                <div class="col-xs-12" style="margin-bottom: 5px;">
                                    ...
                                    echo form_error('en');
                                    echo form_input('en', set_value('en'), 'class="form-control" id="en" placeholder ="VD:Hanoi"');
                                    ?>
                                </div>
                                <div class="col-xs-12" style="margin-bottom: 5px;">
                                    <?php
                                    echo form_label('Tên khu vực đến tiếng Trung phồn thể', 'cn');
                                    echo form_error('cn');
                                    echo form_input('cn', set_value('cn'), 'class="form-control" id="cn" placeholder ="VD:河內"');
                                    ?>
                                </div>
                                <div class="col-xs-12" style="margin-bottom: 5px;">
                                    <?php
                                    echo form_label('Tên khu vực đến tiếng Trung giản thể', 'sc');
                                    echo form_error('sc');
                                    echo form_input('sc', set_value('sc'), 'class="form-control" id="sc" placeholder ="VD:河内"');
                                    ?>
                                </div>
                            </div>
                        </div>
