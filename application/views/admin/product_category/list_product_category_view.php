                    ...
                    <td>
                        <div class="mask_sm">
                            <?php if (!empty(json_decode($value['image']))): ?>
                                <img src="<?php echo base_url('assets/upload/'.$controller.'/'.$value['slug'].'/' .json_decode($value['image'])[count(json_decode($value['image']))-1]) ?>" alt="anh-cua-<?php echo $value['slug'] ?>" width="150px" >
                            <?php else: ?>
                                Không có dữ liệu
                            <?php endif; ?>
                        </div>
