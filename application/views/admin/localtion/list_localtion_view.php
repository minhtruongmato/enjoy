                                ...
                                <div class="col-md-4">
                                        <select name="area_id" class="form-control">
                                            ...
                                            <?php foreach ($area as $key => $value): ?>
                                                <option value="<?php echo $value['id']; ?>" <?php echo ($area_id == $value['id'])?'selected':''; ?>><?php echo $value['en']; ?></option>
                                            <?php endforeach ?>
                                        </select>
                                </div>
                                <div class="col-md-6">
                            ...
                            <table id="table" class="table table_product">
                                ...
                                <?php foreach ($result as $key => $value): ?>
                                    <tr class="remove_<?php echo $value['id']; ?>">
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('admin/'.$controller.'/edit/'. $value['id']) ?>" class="dataActionEdit"><i class="fa fa-pencil" aria-hidden="true" title="Sửa địa điểm"></i> </a>
                                            &nbsp&nbsp&nbsp
