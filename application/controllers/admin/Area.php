...
class Area extends Admin_Controller {
    ...
    public function create(){
        ...
        if($this->input->post()){
            ...
            $this->form_validation->set_rules('cn', 'Khu vực đến tiếng Trung phồn thể', 'required');
            $this->form_validation->set_rules('sc', 'Khu vực đến tiếng Trung giản thể', 'required');
